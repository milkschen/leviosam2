...
OBJS = src/leviosam.o src/bam_aux.o src/bam_md.o src/bed.o src/chain.o \
       src/collate.o src/leviosam_utils.o src/cherry_pick.o src/gzstream.o src/lift_bed.o
CDEPS= src/bam.h
